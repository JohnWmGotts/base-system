...
(function($) {
  ...
  var ORBIT = {
    ...
    setCaption: function () {		
      var captionLocation = this.currentSlide().attr('orbit-caption'),
          captionHTML;
      ...
      if (!this.options.captions) {
		...
		captionLocation = true;
    	if (captionLocation) {
    	  captionHTML = this.currentSlide().attr('orbit-caption'); //get HTML from the matching HTML entity
    		this.$caption
