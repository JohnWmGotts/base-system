<?php
	...
	if(isset($_GET["catId"]) && ($_GET["catId"] != '') && is_numeric($_GET["catId"]))
	{
		...
		if(isset($cityId) && ($cityId != '') && is_numeric($cityId)){
			...
			//$selAllCategories = mysql_fetch_assoc($con->recordselect("SELECT categoryId, categoryName FROM categories ORDER BY categoryName ASC"));
		}
	}
	$title = "Popular Projects";
	$meta = array("description"=>"Popular Projects","keywords"=>"Popular Projects");	
