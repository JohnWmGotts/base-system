	...
	<div class="wrapper">
		<section id="content">
			...
			$sel_reclaunche=$con->recordselect("SELECT `projectStart` , published, projectbasics.projectId
								...
								AND projects.accepted =0
								AND projects.comming_soon =1
								AND (projectbasics.fundingStatus='y' OR projectbasics.fundingStatus='r')
								AND projectbasics.projectEnd>='".$currentTime1."'
