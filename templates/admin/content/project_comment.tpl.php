		...
		<tr class="trcolor">
		  ...
		  ?>
			...
			<td ><div class="protit"><a title="Click here to view project detail" href="javascript:void(0);" onclick="javascript:openPopup('<?php echo $sel_project_all["projectId"]; ?>');"><?php echo unsanitize_string(ucfirst($sel_project_all['projectTitle'])); ?></a></div></td>
            	<td  ><div class="shrtblrb"><?php echo $checkedornot['comment']; ?></div></td>
			<td  ><div class="shrtblrb"><?php echo $checkedornot['name']; ?></div></td>
			<td ><div ><?php echo  date ("m-d-Y H:i:s",$checkedornot['commentTime']); ?></div></td><!--class="proloc"-->
			<td class="icon" width="7%">
				<ul>
					<?php if($checkedornot['commentstatus']==1) { ?>
                    	<li><a href="<?php echo SITE_ADM;?>project_comment.php?action=inactive&amp;id=<?php echo $checkedornot['commentId']; ?>&amp;page=<?php echo $_GET['page']; ?>"onclick="return confirm('Are you sure you want to Inactivate this comment ?')" title="Click here to Inactivate"><img src="<?php echo SITE_ADM_IMG;?>active.gif" border="0" alt="Inactivate" /></a></li>
                    <?php } else { ?>
                    	<li><a href="<?php echo SITE_ADM;?>project_comment.php?action=active&amp;id=<?php echo $checkedornot['commentId']; ?>&amp;page=<?php echo $_GET['page']; ?>"onclick="return confirm('Are you sure you want to Activate this comment?')" title="Click here to Activate"><img src="<?php echo SITE_ADM_IMG;?>block.png" border="0" alt="Activate" /></a></li>
                    <?php } ?>
                    ...
                    <?php }else{ ?>
                    	<li><a href="projectcomment_del.php?id=<?php echo $checkedornot['commentId']; ?>&&type='projectcomment'" onclick="return confirm('Are you sure you want to Delete this Comment?')"  title="Delete"><img src="<?php echo SITE_ADM_IMG;?>delete.png" border="0" alt="Delete" /></a></li>
                    <?php } ?>
