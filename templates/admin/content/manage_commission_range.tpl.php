...
<tr>
	...
	<td class="content">		
		<form action="<?php echo SITE_ADM;?>manage_commission_range.php?id=<?php echo $_GET['id']; ?>&page=<?php echo $_GET['page']; ?>&action=<?php echo $_GET['action'];?>" method="post" name="f1" id="f1">
		...
		<tr>
		  ...
		  <tr>
			...
			<td>
				...
				<input name="" alt="<?php echo $btn_tit; ?>" title="<?php echo $btn_tit; ?>" type="image" src="<?php echo SITE_ADM_IMG.$btn_img;?>" class='save_btn'/> &nbsp; <a href="<?php echo SITE_ADM;?>manage_commission_range.php" title="Cancel"><img src="<?php echo SITE_ADM_IMG;?>cancel-btn.gif" alt="Cancel" /></a>
			</td>
		  </tr>
		  <tr>
			<td height="10" colspan="3"></td>
...
<tr>
	...
	<td class="content">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <?php if($_GET["msg"]=="DELREC" || $_GET["msg"]=="ADDREC" || $_GET["msg"]=="EDITREC" || $_GET["msg"]=="SUCBLO" || $_GET["msg"]=="SUCACT"){ ?>
			<tr align="center">
          ...
          <?php } ?>
		<tr>
			<td align="right"><a href="<?php echo SITE_ADM;?>manage_commission_range.php?action=add" title="Add New Commission Price Range" class="link"><strong>Add New Commission Price Range</strong></a></td>
		</tr>
		<tr>
			<td height="10"></td>
		  </tr>
		...
		<tr class="trcolor">	 
		  ...
		  <tr>
			...
			<td class="icon">
				<ul>
					<li><a href="<?php echo SITE_ADM;?>manage_commission_range.php?action=edit&amp;id=<?php echo $sel_category['id']; ?>&amp;page=<?php echo $_GET['page']; ?>" title="Edit"><img src="<?php echo SITE_ADM_IMG;?>edit.png" border="0" alt="Edit" /></a></li>
                    ...
                    <?php }else{ ?>
                    	<li><a href="<?php echo SITE_ADM;?>manage_commission_range.php?id=<?php echo $sel_category['id']; ?>&action=delete&page=<?php echo $_GET['page']; ?>" onclick="return confirm('Are you sure you want to delete?');" title="Delete"><img src="<?php echo SITE_ADM_IMG;?>delete.png" border="0" alt="Delete" /></a></li>				
                    <?php } ?>
				</ul>
			</td>
		  </tr>
