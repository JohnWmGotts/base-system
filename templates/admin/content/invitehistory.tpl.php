...
<tr>
	...
	<td class="content">
		...
		<tr class="trcolor">
			...
			<th width="27%" align="center" class="header1" id="links">Sender Name</th>
            <th width="12%" align="center" class="header1">Receiver Email</th>
			<th width="12%" align="center" class="header1">Date</th>
		  ...
		  <tr>
            ...
            <td  ><div class="shrtblrb"><?php echo $checkedornot['mailAddress']; ?></div></td>
			<td ><div ><?php echo  date ("m-d-Y H:i:s",$checkedornot['createdDate']); ?></div></td><!--class="proloc"-->
