...
$qury_lang=$con->recordselect("SELECT * FROM categories");
$sheet1=array(array('Category Name','Category Description'));
$i=1;
while($fetch_Record= mysql_fetch_assoc($qury_lang))
{
	...
	echo '</pre>';*/
	$sheet3=array();
	array_push($sheet3,(str_replace('"', '""', $fetch_Record["categoryName"])));
	array_push($sheet3,(str_replace('"', '""', $fetch_Record["categoryDescription"])));
...
$workbook->send('category_detail.xls');
$workbook->close();
