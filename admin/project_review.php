<?php
	...
	if(!isset($_SESSION['admin_user']) || $_SESSION["admin_user"]=="" || !isset($_SESSION['admin_role']) || $_SESSION["admin_role"]==1)
	{
	...
	if(isset($_GET['action']) && $_GET['action']=='active') {
		...
		redirect(SITE_ADM."project_review.php?msg=SUCACT&page=".$page1);
		 ...
		 $sqlQuery = "select p.*, pco.*, us.* from projects as p, projectreview as pco, users as us where p.published=1 and p.accepted!=3 and p.projectId=pco.projectId and pco.userId=us.userId order by pco.created_date DESC";
