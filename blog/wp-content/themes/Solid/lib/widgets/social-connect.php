...
$theme->options['widgets_options']['socialconnect'] =  (isset($theme->options['widgets_options']) && isset($theme->options['widgets_options']['socialconnect']) && is_array($theme->options['widgets_options']['socialconnect']))
