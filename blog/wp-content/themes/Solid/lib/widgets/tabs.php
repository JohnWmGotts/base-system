...
$theme->options['widgets_options']['tabs'] =  (isset($theme->options['widgets_options']) && isset($theme->options['widgets_options']['tabs']) && is_array($theme->options['widgets_options']['tabs']))
