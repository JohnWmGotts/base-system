...
$theme->options['widgets_options']['socialshare'] =  (isset($theme->options['widgets_options']) && isset($theme->options['widgets_options']['socialshare']) && is_array($theme->options['widgets_options']['socialshare']))
