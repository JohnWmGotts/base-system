...
$theme->options['widgets_options']['comments'] =  (isset($theme->options['widgets_options']) && isset($theme->options['widgets_options']['comments']) && is_array($theme->options['widgets_options']['comments']))
