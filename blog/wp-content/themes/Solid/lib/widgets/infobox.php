...
$theme->options['widgets_options']['infobox'] =  (isset($theme->options['widgets_options']) && isset($theme->options['widgets_options']['infobox']) && is_array($theme->options['widgets_options']['infobox']))
