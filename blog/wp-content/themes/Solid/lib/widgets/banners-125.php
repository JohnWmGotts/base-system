...
$theme->options['widgets_options']['banners125'] = (isset($theme->options['widgets_options']) && isset($theme->options['widgets_options']['banners125']) && is_array($theme->options['widgets_options']['banners125']))
    ...
    function widget($args, $instance)
    {
        ...
        $returnval = '';
         if(is_array($get_banners)) {
            $returnval .= '<ul class="widget-wrap"><li class="banners-125">';
