    ...
    class FlexiThemes_FeaturedPosts
    {
        ...
        function themater_options()
        {
            $this->theme->admin_option(array('Featured Posts', 15), 
                ...
                array('options' =>array('homepage'=>'Homepage', 'static'=>'Static Page (When a static page is set as front page from the "wp-admin / Settings / Reading" options page)', 'categories' => 'Category Pages', 'tags' => 'Tag Pages', 'archives' => 'Archive Pages', 'searches'=>'Search Results Pages'), 'help'=> 'Enable featured posts slideshow at:', 'display'=>'extended-top')
            );
